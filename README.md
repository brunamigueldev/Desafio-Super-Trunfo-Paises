...
Este projeto foi desenvolvido como parte de um exercício proposto pela minha faculdade, na disciplina de programação em C (nível básico). O objetivo foi aplicar conceitos fundamentais da linguagem, como lógica de programação, manipulação de variáveis, operadores e conversão de tipos de dados.
...
Ao concluir todos os níveis, será criado um sistema incial para o jogo Super Trunfo, com funcionalidades de cadastro, cálculo e comparação de propriedades. 
